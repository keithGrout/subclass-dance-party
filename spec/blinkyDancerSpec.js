...
it("should have a jQuery $node square dancer object", function(){
    expect(squareDancer.$node).to.be.an.instanceof(jQuery);
  });

  it("should have a step function that makes its square node blink", function() {
  ...
  describe("dance", function(){
    it("should call square dancer step at least once per second", function(){
